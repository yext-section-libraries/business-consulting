...
type BusinessConsultingHeaderSectionProps = {
...
const BusinessConsultingHeaderSectionFields: YextFields<BusinessConsultingHeaderSectionProps> = {
  section: {
    label: "Section",
    type: "object",
    objectFields: {
...
const BusinessConsultingHeaderSectionComponent: PuckComponent<BusinessConsultingHeaderSectionProps> = (props) => {
...
export const BusinessConsultingHeaderSection: YextComponentConfig<BusinessConsultingHeaderSectionProps> = {
  ...
  render: (props) => (
    <AnalyticsScopeProvider
      name={`BusinessConsultingHeaderSection${getAnalyticsScopeHash(props.id)}`}
    >
      <BusinessConsultingHeaderSectionComponent {...props} />
    </AnalyticsScopeProvider>
  ),
};
