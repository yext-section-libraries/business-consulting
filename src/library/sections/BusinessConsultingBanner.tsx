...
type BusinessConsultingBannerProps = {
  data: {
...
const BusinessConsultingBannerFields: YextFields<BusinessConsultingBannerProps> = {
  data: {
    label: "Banner Text",
    type: "object",
    objectFields: {
...
const BusinessConsultingBannerComponent: PuckComponent<BusinessConsultingBannerProps> = ({
  data,
  styles,
  section,
  puck,
...
export const BusinessConsultingBanner: YextComponentConfig<BusinessConsultingBannerProps> = {
  ...
  render: (props) => (
    ...
    >
      <BusinessConsultingBannerComponent {...props} />
    </VisibilityWrapper>
  ),
};

export const config: SectionConfig = {
  id: "BusinessConsultingBanner",
  displayName: "Banner",
  description: "Banner",
  pageSetTypes: ["ENTITY"],
};
